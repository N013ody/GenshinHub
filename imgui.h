...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_DropFiles              = 1 << 20,  // Allow dnd of files into the window
    ImGuiWindowFlags_BlurBackGround         = 1 << 21,
    ImGuiWindowFlags_AttachedWindow         = 1 << 22,
    ImGuiWindowFlags_ShadowWindow           = 1 << 23,
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_AnimText            = 1 << 23,  //Anim Text
    ImGuiInputTextFlags_AnimScroll          = 1 << 24,  //Anim Scroll
    ImGuiInputTextFlags_AnimTextColor            = 1 << 25,  //Anim Text
    // Obsolete names
